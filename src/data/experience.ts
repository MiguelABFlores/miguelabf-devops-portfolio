...
export const experience: Job[] = [
  {
    ...
    highlights: [
      ...
      'Designed and executed recovery plans for critical internal services',
      'Improved server stability by identifying and fixing security vulnerabilities',
      'Maintained and hardened Linux servers running internal Oracle applications',
      'Proposed and introduced new tooling to strengthen infrastructure reliability',
    ],
